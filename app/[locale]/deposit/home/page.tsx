...
export default function Page() {
    ...
    return (
        <div className="flex flex-col min-h-screen w-full">
            <Header title={trans("stepOne.stepOne-subOneLogement.title")}
                    question={trans("stepOne.stepOne-subOneLogement.title")}
                ...
                <span className="font-bold text-sm">
                    ...
                    <div className="flex flex-row gap-4 mt-4 font-semibold ">
                        <Button onPress={() => handleUpdate("typeOfLogement", "APPARTEMENT")}
                            ...
                            <Image src="/images/appartment_choice_picture.png" alt="appartment choice" width={174}
                                   height={174}
                                   className="w-2/3"/>
                        ...
                        <Button onPress={() => handleUpdate("typeOfLogement", "MAISON")} variant="bordered"
                                color="primary"
            ...
            <Footer onPrevious={handlePrevious} onNext={handleNext} requiredField={['typeOfLogement']} step={1}/>
        </div>
